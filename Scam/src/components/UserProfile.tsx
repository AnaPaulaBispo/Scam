...
const UserProfile = ({ userId, userName, onPlay, onLogout, onUserNameUpdate }: UserProfileProps) => {
  ...
  return (
    <motion.div
      className="bg-gradient-to-br from-purple-50 via-white to-blue-50 rounded-2xl shadow-2xl p-10 max-w-7xl w-full mx-auto border border-white/70"
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
    ...
    >
      ...
      <div className="mb-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-sm md:text-base text-gray-600 mt-1">
              Acompanhe sua evolução e personalize sua experiência no simulador.
            </p>
          </div>
          <motion.button
            onClick={onPlay}
            className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl font-bold text-base md:text-lg shadow-lg hover:shadow-xl transition-all"
        ...
        <div className="mb-6 pb-4 border-b border-purple-100 flex items-center gap-2">
      ...
      {attempts.length > 0 ? (
        ...
        <div className="mb-8 text-center py-8 bg-gray-50 rounded-2xl border border-dashed border-gray-200">
        ...
        {isEditModalOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              {/* Footer do Modal */}
              <div className="flex flex-wrap gap-2 justify-between items-center p-4 border-t">
                <button
                  type="button"
                  onClick={() => {
                    // Fecha o modal de edição e abre a confirmação de logout
                    closeEditModal();
                    setShowLogoutConfirm(true);
                  }}
                  className="flex items-center gap-2 px-4 py-2 bg-red-50 hover:bg-red-100 text-red-600 rounded-md transition-colors"
